...
def test_streak_calculation_increment():
    habit = Habit(id=1, name="Read", habit_type=HabitType.BINARY, numeric_target=None, numeric_unit=None, streak=Streak(5, 10), chat_id=ChatId(1), created_at=datetime.datetime.now())
    last_checkin = HabitCheckIn(id=1, habit_id=1, effective_date=datetime.date(2026, 1, 1), value_bool=True, value_numeric=None, checked_at=datetime.datetime.now())
...
def test_streak_longest_update():
    habit = Habit(id=1, name="Read", habit_type=HabitType.BINARY, numeric_target=None, numeric_unit=None, streak=Streak(10, 10), chat_id=ChatId(1), created_at=datetime.datetime.now())
    last_checkin = HabitCheckIn(id=1, habit_id=1, effective_date=datetime.date(2026, 1, 1), value_bool=True, value_numeric=None, checked_at=datetime.datetime.now())
